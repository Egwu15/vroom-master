...
class ChatsHistory extends StatefulWidget {
  @override
  _ChatsHistoryState createState() => _ChatsHistoryState();
}
...
class _ChatsHistoryState extends State<ChatsHistory> {
  ...
  void initState() {
    super.initState();
    getUserId();
     timer = Timer.periodic(Duration(seconds: 4), (Timer t) => getChatted());
